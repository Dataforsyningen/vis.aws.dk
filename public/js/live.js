  ...
  var visData= function() {
    ...
    .then( function ( data ) {
      for (var i= 0; i<data.length; i++) {
        ...
        var marker= L.circleMarker(L.latLng(wgs84.y, wgs84.x), {color: color, fillColor: color, stroke: false, fillOpacity: 1.0, radius: data[i].operation==='update'?3:5}).addTo(map);//defaultpointstyle);
